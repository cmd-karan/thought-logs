...
const posts = [{
    ...
    postBody: "<p><em>I am </em><strong><em>Aman Khanna</em></strong><em>.</em></p><p>I am scared due to sudden changes happening on <em><u>entrance examination</u></em> side.</p><p>But I am <u>damn sure</u> that </p><blockquote>I will give my best as things are coherent with all students.</blockquote><p><em>Cheers! </em></p><p><em>Aman.</em></p>",
    author: "Andy Georges",
    date: new Date(),
    readingTime: 5
}, {
